...
This project opts for a `tensorforce` approach and provides working solutions for both CartPole and LunarLander environments, with results shown in this README.md. `tensorforce` was chosen rather than the other rl frameworks mentioned above mainly for it's excellent documentation, high level design principles and active community support (Gitter). 
